...
class ejercicios:
    ...
    def ejercicio_16(self):
        ...
        plt.plot(x, np.sin(x), label=r"$\sin(x)$", color="blue")
        plt.legend()
        plt.title("Gráfico de dispersión")
        plt.xlabel("Eje X")
        plt.ylabel("Eje Y")
    ...
    def ejercicio_18(self):
        ...
        plt.figure()
        plt.hist(array18_1, bins=30, alpha=0.5, label="Array_1")
        plt.hist(array18_2, bins=30, alpha=0.5, label="Array_2")
        plt.legend()
    ...
    def ejercicio_21(self):
        ...
        plt.figure()
        plt.hist(array21_1, bins=30, alpha=0.5, color="yellow", label="Array 1")
        plt.hist(array21_2, bins=30, alpha=0.5, color="blue", label="Array 2")
        plt.legend()
        plt.title("Histograma con dos distribuciones")
        plt.xlabel("Valor")
        plt.ylabel("Frecuencia")
